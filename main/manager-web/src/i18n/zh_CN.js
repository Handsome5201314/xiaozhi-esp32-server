export default {
  ...
  'device.aliasTooLong': '设备别名不能超过 64 字符',
  'device.aliasSaved': '设备别名已保存',
  'device.aliasSaveFailed': '设备别名保存失败',
  ...
  'home.confirmDeleteAgent': '删除后无法恢复。请输入智能体名称或 ID“{agentName}”确认删除。',
  'home.deleteAgentNamePlaceholder': '请输入智能体名称或 ID',
  'home.deleteAgentNameMismatch': '输入的智能体名称或 ID 不匹配',
  'home.deleteAgentPasteForbidden': '请手动输入智能体名称或 ID，不允许粘贴',
  ...
  'paramManagement.valueType': '类型',
  'paramManagement.remark': '备注',
  'paramManagement.operation': '操作',
  'paramManagement.select': '选择',
  ...
  'paramManagement.refresh': '刷新',
  'paramManagement.itemsPerPage': '条/页',
  'paramManagement.firstPage': '首页',
  'paramManagement.prevPage': '上一页',
  'paramManagement.nextPage': '下一页',
  'paramManagement.totalRecords': '共{total}条',
  'paramManagement.selectedCount': '已选 {count} 项',
  'paramManagement.groupHint': '按命名空间聚合展示',
  'paramManagement.emptyResult': '没有匹配的参数',
  'paramManagement.group.all': '全部',
  'paramManagement.group.server': '服务端',
  'paramManagement.group.plugins': '插件',
  'paramManagement.group.log': '日志',
  'paramManagement.group.session': '会话',
  'paramManagement.group.general': '通用',
  'paramManagement.subgroup.root': '基础配置',
  'paramManagement.subgroup.auth': '鉴权',
  'paramManagement.subgroup.connection': '连接',
  'paramManagement.subgroup.registry': '实例注册',
  'paramManagement.subgroup.resilience': '韧性 / 熔断',
  'paramManagement.subgroup.metrics': '指标',
  'paramManagement.subgroup.tracing': '链路追踪',
  'paramManagement.subgroup.plugin': '插件 · {name}',
  ...
  'knowledgeBaseDialog.chunkMethod': '解析模式',
  'knowledgeBaseDialog.chunkMethodPlaceholder': '请选择解析模式',
  'knowledgeBaseDialog.chunkMethodRequired': '请选择解析模式',
  'knowledgeBaseDialog.advancedParserConfig': '高级解析配置',
  'knowledgeBaseDialog.chunkTokenNum': '切片 Token',
  'knowledgeBaseDialog.chunkTokenNumPlaceholder': '例如 512 或 1024',
  'knowledgeBaseDialog.layoutRecognize': '布局识别',
  'knowledgeBaseDialog.layoutRecognizePlaceholder': '请选择布局识别',
  'knowledgeBaseDialog.delimiter': '分隔符',
  'knowledgeBaseDialog.delimiterPlaceholder': '例如 \\n',
  'knowledgeBaseDialog.autoKeywords': '自动关键词',
  'knowledgeBaseDialog.autoQuestions': '自动问题',
  'knowledgeBaseDialog.html4excel': '表格转 HTML',
  'knowledgeBaseDialog.chunkMethodNaive': '通用文档',
  'knowledgeBaseDialog.chunkMethodPaper': '论文',
  'knowledgeBaseDialog.chunkMethodTable': '表格',
  'knowledgeBaseDialog.chunkMethodQa': '问答',
  'knowledgeBaseDialog.chunkMethodBook': '书籍',
  'knowledgeBaseDialog.chunkMethodLaws': '法律法规',
  'knowledgeBaseDialog.chunkMethodPresentation': '演示文稿',
  'knowledgeBaseDialog.chunkMethodPicture': '图片',
  'knowledgeBaseDialog.chunkMethodOne': '整文档',
  'knowledgeBaseDialog.chunkMethodManual': '手动',
  'knowledgeBaseDialog.chunkMethodKnowledgeGraph': '知识图谱',
  'knowledgeBaseDialog.chunkMethodEmail': '邮件',
  ...
  'knowledgeFileUpload.inheritParserConfig': '上传文件将继承：',
