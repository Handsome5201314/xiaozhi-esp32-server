export default {
  ...
  'device.aliasTooLong': '設備別名不能超過 64 字符',
  'device.aliasSaved': '設備別名已保存',
  'device.aliasSaveFailed': '設備別名保存失敗',
  ...
  'home.confirmDeleteAgent': '刪除後無法復原。請輸入智能體名稱或 ID「{agentName}」確認刪除。',
  'home.deleteAgentNamePlaceholder': '請輸入智能體名稱或 ID',
  'home.deleteAgentNameMismatch': '輸入的智能體名稱或 ID 不匹配',
  'home.deleteAgentPasteForbidden': '請手動輸入智能體名稱或 ID，不允許貼上',
  ...
  'paramManagement.valueType': '類型',
  'paramManagement.remark': '備註',
  'paramManagement.operation': '操作',
  'paramManagement.select': '選擇',
  ...
  'paramManagement.refresh': '重新整理',
  'paramManagement.itemsPerPage': '條/頁',
  'paramManagement.firstPage': '首頁',
  'paramManagement.prevPage': '上一頁',
  'paramManagement.nextPage': '下一頁',
  'paramManagement.totalRecords': '共{total}條',
  'paramManagement.selectedCount': '已選 {count} 項',
  'paramManagement.groupHint': '依命名空間聚合顯示',
  'paramManagement.emptyResult': '沒有符合的參數',
  'paramManagement.group.all': '全部',
  'paramManagement.group.server': '服務端',
  'paramManagement.group.plugins': '外掛',
  'paramManagement.group.log': '日誌',
  'paramManagement.group.session': '會話',
  'paramManagement.group.general': '通用',
  'paramManagement.subgroup.root': '基礎設定',
  'paramManagement.subgroup.auth': '鑑權',
  'paramManagement.subgroup.connection': '連線',
  'paramManagement.subgroup.registry': '實例註冊',
  'paramManagement.subgroup.resilience': '韌性 / 熔斷',
  'paramManagement.subgroup.metrics': '指標',
  'paramManagement.subgroup.tracing': '鏈路追蹤',
  'paramManagement.subgroup.plugin': '外掛 · {name}',
  ...
  'knowledgeBaseDialog.chunkMethodPlaceholder': '請選擇解析模式',
  'knowledgeBaseDialog.chunkMethodRequired': '請選擇解析模式',
  'knowledgeBaseDialog.advancedParserConfig': '高級解析配置',
  'knowledgeBaseDialog.chunkTokenNum': '切片 Token',
  'knowledgeBaseDialog.chunkTokenNumPlaceholder': '例如 512 或 1024',
  'knowledgeBaseDialog.layoutRecognize': '版面識別',
  'knowledgeBaseDialog.layoutRecognizePlaceholder': '請選擇版面識別',
  'knowledgeBaseDialog.delimiter': '分隔符',
  'knowledgeBaseDialog.delimiterPlaceholder': '例如 \\n',
  'knowledgeBaseDialog.autoKeywords': '自動關鍵詞',
  'knowledgeBaseDialog.autoQuestions': '自動問題',
  'knowledgeBaseDialog.html4excel': '表格轉 HTML',
  'knowledgeBaseDialog.chunkMethodNaive': '通用文檔',
  'knowledgeBaseDialog.chunkMethodPaper': '論文',
  'knowledgeBaseDialog.chunkMethodTable': '表格',
  'knowledgeBaseDialog.chunkMethodQa': '問答',
  'knowledgeBaseDialog.chunkMethodBook': '書籍',
  'knowledgeBaseDialog.chunkMethodLaws': '法律法規',
  'knowledgeBaseDialog.chunkMethodPresentation': '簡報',
  'knowledgeBaseDialog.chunkMethodPicture': '圖片',
  'knowledgeBaseDialog.chunkMethodOne': '整文檔',
  'knowledgeBaseDialog.chunkMethodManual': '手動',
  'knowledgeBaseDialog.chunkMethodKnowledgeGraph': '知識圖譜',
  'knowledgeBaseDialog.chunkMethodEmail': '郵件',
  ...
  'knowledgeFileUpload.inheritParserConfig': '上傳文件將繼承：',
