export default {
  ...
  'device.aliasTooLong': 'Gerätealias darf 64 Zeichen nicht überschreiten',
  'device.aliasSaved': 'Gerätealias erfolgreich gespeichert',
  'device.aliasSaveFailed': 'Speichern des Gerätealias fehlgeschlagen',
  ...
  'home.confirmDeleteAgent': 'Das Löschen kann nicht rückgängig gemacht werden. Geben Sie den Agentennamen oder die ID "{agentName}" ein, um zu bestätigen.',
  'home.deleteAgentNamePlaceholder': 'Agentennamen oder ID eingeben',
  'home.deleteAgentNameMismatch': 'Der Agentenname oder die ID stimmt nicht überein',
  'home.deleteAgentPasteForbidden': 'Bitte geben Sie den Agentennamen oder die ID manuell ein. Einfügen ist nicht erlaubt.',
  ...
  'paramManagement.refresh': 'Aktualisieren',
  ...
  'paramManagement.totalRecords': '{total} insgesamt',
  'paramManagement.selectedCount': '{count} ausgewählt',
  'paramManagement.groupHint': 'Nach Namespace gruppiert',
  'paramManagement.emptyResult': 'Keine passenden Parameter',
  'paramManagement.group.all': 'Alle',
  'paramManagement.group.server': 'Server',
  'paramManagement.group.plugins': 'Plugins',
  'paramManagement.group.log': 'Logging',
  'paramManagement.group.session': 'Sitzung',
  'paramManagement.group.general': 'Allgemein',
  'paramManagement.subgroup.root': 'Basis',
  'paramManagement.subgroup.auth': 'Auth',
  'paramManagement.subgroup.connection': 'Verbindung',
  'paramManagement.subgroup.registry': 'Registry',
  'paramManagement.subgroup.resilience': 'Resilience',
  'paramManagement.subgroup.metrics': 'Metriken',
  ...
  'knowledgeBaseDialog.chunkMethod': 'Parse-Modus',
  'knowledgeBaseDialog.chunkMethodPlaceholder': 'Bitte Parse-Modus auswählen',
  'knowledgeBaseDialog.chunkMethodRequired': 'Bitte Parse-Modus auswählen',
  'knowledgeBaseDialog.advancedParserConfig': 'Erweiterte Parser-Konfiguration',
  'knowledgeBaseDialog.chunkTokenNum': 'Chunk-Tokens',
  'knowledgeBaseDialog.chunkTokenNumPlaceholder': 'Zum Beispiel 512 oder 1024',
  'knowledgeBaseDialog.layoutRecognize': 'Layout-Erkennung',
  'knowledgeBaseDialog.layoutRecognizePlaceholder': 'Bitte Layout-Erkennung auswählen',
  'knowledgeBaseDialog.delimiter': 'Trennzeichen',
  'knowledgeBaseDialog.delimiterPlaceholder': 'Zum Beispiel \\n',
  'knowledgeBaseDialog.autoKeywords': 'Auto-Schlüsselwörter',
  'knowledgeBaseDialog.autoQuestions': 'Auto-Fragen',
  'knowledgeBaseDialog.html4excel': 'Excel zu HTML',
  'knowledgeBaseDialog.chunkMethodNaive': 'Allgemeines Dokument',
  'knowledgeBaseDialog.chunkMethodPaper': 'Paper',
  'knowledgeBaseDialog.chunkMethodTable': 'Tabelle',
  'knowledgeBaseDialog.chunkMethodQa': 'Q&A',
  'knowledgeBaseDialog.chunkMethodBook': 'Buch',
  'knowledgeBaseDialog.chunkMethodLaws': 'Gesetze',
  'knowledgeBaseDialog.chunkMethodPresentation': 'Präsentation',
  'knowledgeBaseDialog.chunkMethodPicture': 'Bild',
  'knowledgeBaseDialog.chunkMethodOne': 'Ganzes Dokument',
  'knowledgeBaseDialog.chunkMethodManual': 'Manuell',
  'knowledgeBaseDialog.chunkMethodKnowledgeGraph': 'Knowledge Graph',
