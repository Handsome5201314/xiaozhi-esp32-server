export default {
  ...
  'device.aliasTooLong': 'Bí danh thiết bị không được vượt quá 64 ký tự',
  'device.aliasSaved': 'Đã lưu bí danh thiết bị thành công',
  'device.aliasSaveFailed': 'Lưu bí danh thiết bị thất bại',
  ...
  'home.confirmDeleteAgent': 'Không thể hoàn tác sau khi xóa. Nhập tên hoặc ID tác nhân "{agentName}" để xác nhận.',
  'home.deleteAgentNamePlaceholder': 'Nhập tên hoặc ID tác nhân',
  'home.deleteAgentNameMismatch': 'Tên hoặc ID tác nhân không khớp',
  'home.deleteAgentPasteForbidden': 'Vui lòng nhập thủ công tên hoặc ID tác nhân. Không được dán.',
  ...
  'paramManagement.refresh': 'Làm mới',
  ...
  'paramManagement.totalRecords': 'Tổng {total}',
  'paramManagement.selectedCount': 'Đã chọn {count}',
  'paramManagement.groupHint': 'Nhóm theo namespace',
  'paramManagement.emptyResult': 'Không có tham số phù hợp',
  'paramManagement.group.all': 'Tất cả',
  'paramManagement.group.server': 'Máy chủ',
  'paramManagement.group.plugins': 'Plugin',
  'paramManagement.group.log': 'Nhật ký',
  'paramManagement.group.session': 'Phiên',
  'paramManagement.group.general': 'Chung',
  'paramManagement.subgroup.root': 'Cơ bản',
  'paramManagement.subgroup.auth': 'Xác thực',
  'paramManagement.subgroup.connection': 'Kết nối',
  'paramManagement.subgroup.registry': 'Đăng ký',
  'paramManagement.subgroup.resilience': 'Resilience',
  'paramManagement.subgroup.metrics': 'Chỉ số',
  ...
  'knowledgeBaseDialog.chunkMethod': 'Chế độ phân tích',
  'knowledgeBaseDialog.chunkMethodPlaceholder': 'Vui lòng chọn chế độ phân tích',
  'knowledgeBaseDialog.chunkMethodRequired': 'Vui lòng chọn chế độ phân tích',
  'knowledgeBaseDialog.advancedParserConfig': 'Cấu hình phân tích nâng cao',
  'knowledgeBaseDialog.chunkTokenNum': 'Token mỗi đoạn',
  'knowledgeBaseDialog.chunkTokenNumPlaceholder': 'Ví dụ 512 hoặc 1024',
  'knowledgeBaseDialog.layoutRecognize': 'Nhận dạng bố cục',
  'knowledgeBaseDialog.layoutRecognizePlaceholder': 'Vui lòng chọn nhận dạng bố cục',
  'knowledgeBaseDialog.delimiter': 'Dấu phân cách',
  'knowledgeBaseDialog.delimiterPlaceholder': 'Ví dụ \\n',
  'knowledgeBaseDialog.autoKeywords': 'Từ khóa tự động',
  'knowledgeBaseDialog.autoQuestions': 'Câu hỏi tự động',
  'knowledgeBaseDialog.html4excel': 'Excel sang HTML',
  'knowledgeBaseDialog.chunkMethodNaive': 'Tài liệu chung',
  'knowledgeBaseDialog.chunkMethodPaper': 'Bài báo',
  'knowledgeBaseDialog.chunkMethodTable': 'Bảng',
  'knowledgeBaseDialog.chunkMethodQa': 'Hỏi đáp',
  'knowledgeBaseDialog.chunkMethodBook': 'Sách',
  'knowledgeBaseDialog.chunkMethodLaws': 'Luật',
  'knowledgeBaseDialog.chunkMethodPresentation': 'Bài trình bày',
  'knowledgeBaseDialog.chunkMethodPicture': 'Hình ảnh',
  'knowledgeBaseDialog.chunkMethodOne': 'Toàn bộ tài liệu',
  'knowledgeBaseDialog.chunkMethodManual': 'Thủ công',
  'knowledgeBaseDialog.chunkMethodKnowledgeGraph': 'Sơ đồ tri thức',
  'knowledgeBaseDialog.chunkMethodEmail': 'Email',
