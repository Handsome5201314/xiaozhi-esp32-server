export default {
  ...
  'device.aliasTooLong': 'Device alias cannot exceed 64 characters',
  'device.aliasSaved': 'Device alias saved successfully',
  'device.aliasSaveFailed': 'Failed to save device alias',
  ...
  'home.confirmDeleteAgent': 'Deletion cannot be undone. Type the agent name or ID "{agentName}" to confirm.',
  'home.deleteAgentNamePlaceholder': 'Enter agent name or ID',
  'home.deleteAgentNameMismatch': 'The agent name or ID does not match',
  'home.deleteAgentPasteForbidden': 'Please type the agent name or ID manually. Pasting is not allowed.',
  ...
  'paramManagement.refresh': 'Refresh',
  ...
  'paramManagement.totalRecords': '{total} total',
  'paramManagement.selectedCount': '{count} selected',
  'paramManagement.groupHint': 'Grouped by namespace',
  'paramManagement.emptyResult': 'No matching parameters',
  'paramManagement.group.all': 'All',
  'paramManagement.group.server': 'Server',
  'paramManagement.group.plugins': 'Plugins',
  'paramManagement.group.log': 'Logging',
  'paramManagement.group.session': 'Session',
  'paramManagement.group.general': 'General',
  'paramManagement.subgroup.root': 'Basics',
  'paramManagement.subgroup.auth': 'Auth',
  'paramManagement.subgroup.connection': 'Connection',
  'paramManagement.subgroup.registry': 'Registry',
  'paramManagement.subgroup.resilience': 'Resilience',
  'paramManagement.subgroup.metrics': 'Metrics',
  ...
  'knowledgeBaseDialog.chunkMethod': 'Parse Mode',
  'knowledgeBaseDialog.chunkMethodPlaceholder': 'Please select parse mode',
  'knowledgeBaseDialog.chunkMethodRequired': 'Please select parse mode',
  'knowledgeBaseDialog.advancedParserConfig': 'Advanced Parser Config',
  'knowledgeBaseDialog.chunkTokenNum': 'Chunk Tokens',
  'knowledgeBaseDialog.chunkTokenNumPlaceholder': 'For example 512 or 1024',
  'knowledgeBaseDialog.layoutRecognize': 'Layout Recognition',
  'knowledgeBaseDialog.layoutRecognizePlaceholder': 'Please select layout recognition',
  'knowledgeBaseDialog.delimiter': 'Delimiter',
  'knowledgeBaseDialog.delimiterPlaceholder': 'For example \\n',
  'knowledgeBaseDialog.autoKeywords': 'Auto Keywords',
  'knowledgeBaseDialog.autoQuestions': 'Auto Questions',
  'knowledgeBaseDialog.html4excel': 'Excel to HTML',
  'knowledgeBaseDialog.chunkMethodNaive': 'General Document',
  'knowledgeBaseDialog.chunkMethodPaper': 'Paper',
  'knowledgeBaseDialog.chunkMethodTable': 'Table',
  'knowledgeBaseDialog.chunkMethodQa': 'Q&A',
  'knowledgeBaseDialog.chunkMethodBook': 'Book',
  'knowledgeBaseDialog.chunkMethodLaws': 'Laws',
  'knowledgeBaseDialog.chunkMethodPresentation': 'Presentation',
  'knowledgeBaseDialog.chunkMethodPicture': 'Picture',
  'knowledgeBaseDialog.chunkMethodOne': 'Whole Document',
